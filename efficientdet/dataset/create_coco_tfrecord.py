...
def _create_tf_record_from_coco_annotations(annotations_file, image_dir,
    ...
    with contextlib2.ExitStack() as tf_record_close_stack, \
        ...
        output_tfrecords = tfrecord_util.open_sharded_output_tfrecords(
...
def main(_):
    ...
    if FLAGS.test_image_dir and FLAGS.testdev_annotations_file:
        ...
        _create_tf_record_from_coco_annotations(
            ...
            FLAGS.include_masks,
            num_shards=100)
    print('converted coco dataset: {}'.format(converted_set))
